# Spec: Inbox / Today Board

## Purpose
Відображати задачі зі станів `inbox` та `today` на головній сторінці й дозволяти
користувачу переносити задачу з Inbox у Today без перезавантаження сторінки.
